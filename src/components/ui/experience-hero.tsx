...
export const Component = () => {
  ...
  return (
    <section ref={containerRef} className="relative min-h-screen w-full bg-[#000000] flex flex-col selection:bg-white selection:text-black overflow-hidden">
      ...
      <div ref={revealRef} className="relative z-10 w-full flex flex-col md:flex-row p-8 md:p-14 lg:p-20 min-h-screen items-center md:items-stretch gap-10">
        <div className="flex-1 min-w-0 flex flex-col justify-between pb-12 md:pb-8 w-full">
          <div className="flex items-center gap-3">
             ...
             <span className="font-mono text-[11px] font-bold text-white tracking-[0.2em] uppercase">DP.LAB</span>
          </div>

          <div className="max-w-4xl lg:-translate-y-8 pr-12 mt-12 md:mt-0">
            <h1 className="text-[clamp(2.5rem,7.5vw,9rem)] font-black leading-[0.87] tracking-tighter text-white uppercase italic-none">
              DURGA <br /> 
              <span style={{ WebkitTextStroke: "1.5px rgba(255, 255, 255, 0.6)", WebkitTextFillColor: "transparent" }}>
                PRASAD D
              </span>
            </h1>
            <p className="mt-8 font-mono text-[11px] text-white/50 uppercase tracking-[0.35em] max-w-sm leading-relaxed">
          ...
          >
             ...
             <span className="font-mono text-[11px] font-bold text-white uppercase tracking-[0.2em]">Download Resume</span>
          </button>
        </div>
        ...
        <div className="w-full md:w-80 lg:w-96 flex-shrink-0 flex flex-col gap-4 justify-center z-20">
          {[
            ...
            <div key={item.id} className="command-cell glass-panel p-6 sm:p-7 block opacity-1 bg-black/40 border border-white/10 rounded-2xl backdrop-blur-md">
              ...
              {item.type === "progress" ? (
                <div className="flex justify-between items-end mt-2">
                  ...
                  <div className="h-[2px] w-20 bg-white/5 rounded-full overflow-hidden">
                     <div className="h-full bg-white w-[85%] animate-loading" />
                  </div>
                </div>
              ) : item.type === "data" ? (
