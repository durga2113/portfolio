...
export default function Projects() {
  return (
    <section id="projects" className="py-24 relative overflow-hidden">
      ...
      <div className="absolute bottom-10 left-10 w-96 h-96 rounded-full glow-spot-emerald opacity-20 -z-10 pointer-events-none" />
        ...
        >
          ...
          <div className="relative w-20 h-20 mx-auto mb-6 flex items-center justify-center">
            ...
            <div className="relative p-5 rounded-full border border-cyan-glow/20 bg-[#F5EBE0]/20 dark:bg-[#000000]/60 text-cyan-glow">
              <FlaskConical className="w-10 h-10 animate-bounce" style={{ animationDuration: '3.5s' }} />
            </div>
          </div>
          ...
          <p className="text-sm md:text-base text-slate-500 dark:text-slate-400 max-w-xl mx-auto leading-relaxed">
            Biotechnology research logs, sterilization logs, and genomic dataset pipelines are undergoing final documentation review. Scientific trials and project reports will be displayed here once approved.
          </p>
          ...
          <div className="mt-8 pt-6 border-t border-slate-300/40 dark:border-slate-800/40 flex items-center justify-center space-x-2 text-[10px] font-mono text-slate-400 select-none">
            <span>PIPELINE: #UNDER_REVIEW</span>
