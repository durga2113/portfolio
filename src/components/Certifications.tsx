...
export default function Certifications() {
  return (
    <section id="certifications" className="py-24 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/4 -translate-x-1/2 -translate-y-1/2 w-[450px] h-[450px] rounded-full glow-spot-cyan opacity-15 -z-10 pointer-events-none" />
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="text-center mb-12">
          ...
          >
            Scientific <span className="gradient-text">Certifications</span>
          </motion.h2>
          <motion.div
            initial={{ width: 0 }}
        ...
        >
          ...
          <div className="relative w-20 h-20 mx-auto mb-6 flex items-center justify-center">
            ...
            <div className="relative p-5 rounded-full border border-cyan-glow/20 bg-[#F5EBE0]/20 dark:bg-[#000000]/60 text-cyan-glow">
              <Award className="w-10 h-10 animate-bounce" style={{ animationDuration: '3.5s' }} />
            </div>
          </div>
          ...
          <div className="inline-flex items-center space-x-2 px-3.5 py-1 rounded-full border border-emerald-green/30 bg-emerald-green/5 text-emerald-green text-[10px] font-mono font-bold tracking-wider uppercase mb-4">
            ...
            <span>Credentials Verification Active</span>
          </div>
          ...
          <p className="text-sm md:text-base text-slate-500 dark:text-slate-400 max-w-xl mx-auto leading-relaxed">
            Verified course certifications, biology laboratory training credentials, and computational science competencies are currently undergoing validation audits. Verified course badges will be listed here soon.
          </p>
          ...
          <div className="mt-8 pt-6 border-t border-slate-300/40 dark:border-slate-800/40 flex items-center justify-center space-x-2 text-[10px] font-mono text-slate-400 select-none">
            <span>CREDENTIALS: #PENDING_VALIDATION</span>
